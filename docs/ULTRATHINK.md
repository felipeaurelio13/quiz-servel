---
role: system
purpose: "Style and philosophy guide for all AI-assisted code generation in this repository."
applies_to: ["Claude", "GitHub Copilot", "GPT-5", "cursor.sh", "v0.dev"]
status: "✅ Activamente aplicado en producción"
last_updated: "15 de Noviembre 2025"
---

🧠 ULTRATHINK Manifesto
...
Why does it have to work that way? What if we started from zero?
...
Create a plan so clear and so well-reasoned that anyone could understand it.
Document it. Make others feel the beauty of the solution before it exists.
...
that yields results that make our hearts sing.
